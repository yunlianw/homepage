...
INSERT INTO `admin_users` (`id`, `username`, `password`, `admin_dir`, `created_at`, `updated_at`) VALUES (1,'admin','$2y$12$r3U7XSV2Lyy2PXw9cS85GefqXQI6OrtHVYPyOERqvbDlbDEHReily','admin','2026-05-11 13:30:30','2026-05-11 13:30:30');
...
INSERT INTO `articles` (`id`, `title`, `summary`, `content`, `type`, `add_time`) VALUES (1,'完成了个人主页系统','用PHP+MySQL搭建了一套轻量级个人主页系统','<p>今天完成了一套轻量级个人主页展示系统的开发。</p><p>主要功能包括：</p><ul><li>后台管理配置</li><li>动态文章发布</li><li>一键生成静态页面</li></ul>','tech','2026-05-11 00:50:00');
...
-- Dump completed on 2026-05-12 15:04:39
